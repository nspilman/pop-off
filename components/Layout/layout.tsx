  ...
  <RootLayout>
    <div className="bg-[#eeeeee] px-8 py-8">
      <div className="container px-4 md:px-6 flex flex-col md:flex-row items-center justify-center w-full">
        <div className="md:py-8 md:mr-8">
          <div
            className={`${bgClass} bg-loop flex items-center content-center justify-center p-8 pl-12 min-w-[300px] sm:min-w-[400px] md:min-w-[300px] lg:min-w-[350px] min-h-[400px] md:min-h-[500px] rounded`}
          >
            <img
              alt="Song cover"
